...
public class BaseTrunkTest {
    public static void baseTrunkTest() {
        for (int i = 0; i < 10; i++)
            printVec(RandomChange.getRandomChangeSlopeOfSlope(new Vec3d(1, 1, 1), 1, .5));
        for (int i = 0; i < 10; i++)
            System.out.println("newTrunkWidth from lastWidth:100,decayRate:5 " + RandomChange.getRandomChangeWidth(100, 1/7.5));
    }
